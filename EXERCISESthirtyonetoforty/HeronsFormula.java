public class HeronsFormula {
    public static void main( String[] args ) {
        ...
        //added one more test to find area of triangle with sides 9,9, and 9 and much easier to add here than without a function
    ...
    public static double triangleArea( int a, int b, int c ) {
        ...
        //fixed bug in formula for odd numbers
        s = (a+b+c) / 2.0;
...
//The version that is without a function is way longer....48 lines compared to 30 lines
